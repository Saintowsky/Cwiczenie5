...
if(e.code == "KeyA"){
    ...
    if (i < 1) {
        i = 5;
        document.getElementById(1).setAttribute("style", `visibility: hidden; position: fixed`)
    }
    if(i == 1)
    {
        document.getElementById(2).setAttribute("style", `visibility: hidden; position: fixed`)
    }
    if(i == 5){
        document.getElementById(i).setAttribute("style", `visibility: hidden; position: fixed`)
    }
    else
    document.getElementById(i+1).setAttribute("style", `visibility: hidden; position: fixed`)
    document.getElementById(i).setAttribute("style", `visibility: visible; position: fixed`)
...
if(e.code == "KeyD"){
    ...
    if (i > pliki.length) {
        i = 1;
        document.getElementById(5).setAttribute("style", `visibility: hidden; position: fixed`)
    }
if (i == 1) {
    document.getElementById(i).setAttribute("style", `visibility: hidden; position: fixed`)
}
...
function Slide(){
    ...
    if(i == 1){
        document.getElementById(5).setAttribute("style", `visibility: hidden; position: fixed`)
        document.getElementById(1).setAttribute("style", `visibility: visible; position: fixed`)
    }
    else
    document.getElementById(i-1).setAttribute("style", `visibility: hidden; position: fixed`)
    document.getElementById(i).setAttribute("style", `visibility: visible; position: fixed`)
